"""add idempotency, status, tenant_id, and invoices tables

Revision ID: daa080205fdb
Revises: 26f67011f40b
Create Date: 2026-07-23 03:06:55.043376
...
revision: str = 'daa080205fdb'
down_revision: Union[str, None] = '26f67011f40b'
...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_saas_service_plans_service_id'), 'saas_service_plans', ['service_id'], unique=False)
    ...
    op.create_index(op.f('ix_affiliate_profiles_user_id'), 'affiliate_profiles', ['user_id'], unique=True)
    ...
    op.create_index('ix_store_profiles_tenant_id', 'store_profiles', ['tenant_id'], unique=False)
    ...
    op.create_index('ix_saas_invoices_tenant_id', 'saas_invoices', ['tenant_id'], unique=False)
    ...
    op.create_index('ix_commerce_audit_logs_order_id', 'commerce_audit_logs', ['order_id'], unique=False)
    op.create_index(op.f('ix_commerce_audit_logs_user_id'), 'commerce_audit_logs', ['user_id'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_commerce_audit_logs_user_id'), table_name='commerce_audit_logs')
    op.drop_index('ix_commerce_audit_logs_order_id', table_name='commerce_audit_logs')
    ...
    op.drop_index('ix_saas_invoices_tenant_id', table_name='saas_invoices')
    ...
    op.drop_index('ix_store_profiles_tenant_id', table_name='store_profiles')
    ...
    op.drop_index(op.f('ix_saas_service_plans_service_id'), table_name='saas_service_plans')
