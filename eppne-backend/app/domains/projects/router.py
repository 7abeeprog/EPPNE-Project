...
async def create_project(
    ...
    return await service.create_project(owner_id=user_id, tenant_id=tenant_id, data=data)
...
async def update_project(
    ...
    return await service.update_project(
        project_id, tenant_id, user_id, data.model_dump(exclude_unset=True)
    )
...
async def publish_project(
    ...
    user_id = cast(int, current_user.id)
    tenant_id = cast(int, current_user.tenant_id)
    return await service.publish_project(project_id, user_id, tenant_id)
...
async def delete_project(
    ...
    user_id = cast(int, current_user.id)
    tenant_id = cast(int, current_user.tenant_id)
    await service.delete_project(project_id, tenant_id, user_id, soft=soft)
    return None
...
async def get_contribution(
    ...
    service = ProjectService(db)
    tenant_id = cast(int, current_user.tenant_id)
    return await service.get_contribution(contribution_id, tenant_id)
...
async def approve_contribution(
    ...
    return await service.approve_contribution(
        contribution_id, user_id, tenant_id, approve_data.approved, approve_data.notes
    )
...
async def add_milestone(
    ...
    user_id = cast(int, current_user.id)
    tenant_id = cast(int, current_user.tenant_id)
    return await service.add_milestone(project_id, user_id, tenant_id, data)
...
async def complete_milestone(
    ...
    user_id = cast(int, current_user.id)
    tenant_id = cast(int, current_user.tenant_id)
    return await service.complete_milestone(milestone_id, user_id, tenant_id, complete_data)
...
async def get_milestones(
    ...
    service = ProjectService(db)
    tenant_id = cast(int, current_user.tenant_id)
    return await service.get_milestones(project_id, tenant_id)
...
async def follow_project(
    ...
    user_id = cast(int, current_user.id)
    tenant_id = cast(int, current_user.tenant_id)
    await service.follow_project(user_id, project_id, tenant_id)
...
async def unfollow_project(
    ...
    user_id = cast(int, current_user.id)
    tenant_id = cast(int, current_user.tenant_id)
    await service.unfollow_project(user_id, project_id, tenant_id)
    return None
...
async def get_followers(
    ...
    service = ProjectService(db)
    tenant_id = cast(int, current_user.tenant_id)
    return await service.get_followers(project_id, tenant_id, skip, min(limit, 200))
...
async def add_project_update(
    ...
    return await service.add_project_update(
        project_id, user_id, tenant_id, data.title, data.content, data.media_urls
    )
...
async def get_project_updates(
    ...
    service = ProjectService(db)
    tenant_id = cast(int, current_user.tenant_id)
    return await service.get_project_updates(project_id, tenant_id, skip, min(limit, 200))
...
async def get_analytics(
    ...
    service = ProjectService(db)
    tenant_id = cast(int, current_user.tenant_id)
    analytics = await service.get_project_analytics(project_id, tenant_id)
