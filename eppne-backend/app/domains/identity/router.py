...
async def register(
    ...
    """إنشاء حساب جديد مع Idempotency Key."""
...
async def get_me(
    ...
    service = UserService(db)
    user = await service.get_current_user(user_id=cast(int, current_user.id))
    return user


# ============================================================
# 4. تحديث المستخدم (Update Me)
# ============================================================
...
# ============================================================
# 7. إبطال جميع الجلسات (Revoke All)
# ============================================================
