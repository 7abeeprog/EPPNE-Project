...
# ============================================
# ⚠️ موديل "مجمَّد" بقرار منتجي مقصود (academy-product-decisions.md §1-د):
# الأقساط آلية دفع عامة غير خاصة بالتعليم (تنطبق على المتجر/التأمين/العقارات أيضًا).
# لا تُصلَح ولا تُستكمل هنا — بانتظار خدمة أقساط مشتركة عبر القطاعات (جلسة تصميم منفصلة).
