        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="space-y-2">
            ...
            <Input
              id="name_en"
              type="text"
              placeholder="أدخل اسمك بالإنجليزية..."
              value={nameEn}
              onChange={(e) => setNameEn(e.target.value)}
              className="h-14 bg-background/50 border-white/10 rounded-xl focus:border-primary focus:ring-1 focus:ring-primary/50 shadow-inner text-lg rtl:text-left"
              disabled={registerMutation.isPending}
            />
          </div>
